...
tests = [ {'description': 'PINA: 0x00 => PORTC: 0x03',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 1 } ],
    'expected': [('PORTC',0x03)],
    },
    {'description': 'PINA: 0x01 => PORTC: 0x02',
    ...
    {'description': 'PINA: 0x04 => PORTC: 0x02',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 1 } ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'PINA: 0x05 => PORTC: 0x01',
    'steps': [ {'inputs': [('PINA',0x05)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'PINA: 0x06 => PORTC: 0x01',
    'steps': [ {'inputs': [('PINA',0x06)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'PINA: 0x07 => PORTC: 0x00',
